...
class configuration:
    ...
    controlPlots = [
        controlPlot("selection", "EventSelectionControlPlots", "EventSelectionControlPlots", {}),
    ...
    eventCollections = [
        eventCollection("genEvent", "Event"),
    ...
    eventProducers = [
        eventProducer("category", "TtbarEventSelection", "eventCategory", {}),
        eventProducer("selectedJets", "TopReconstruction", "jetSelection", {"ptcut": 20.0, "etacut": 2.4}),
