...
module SimpleCalorimeter LumiCalF {
    ...
    source CLIC/CLICdet_LumiCalF_Binning.tcl
    source CLIC/CLICdet_LumiCal_EnergyFractions.tcl
    source CLIC/CLICdet_LumiCal_Resolution_Stage3.tcl
}
...
module SimpleCalorimeter LumiCalR {
    ...
    source CLIC/CLICdet_LumiCalR_Binning.tcl
    source CLIC/CLICdet_LumiCal_EnergyFractions.tcl
    source CLIC/CLICdet_LumiCal_Resolution_Stage3.tcl
}
...
module SimpleCalorimeter BeamCalR {
    ...
    source CLIC/CLICdet_BeamCalR_Binning.tcl
    source CLIC/CLICdet_BeamCal_EnergyFractions.tcl
    source CLIC/CLICdet_BeamCal_Resolution_Stage3.tcl
}
...
module SimpleCalorimeter BeamCalF {
    ...
    source CLIC/CLICdet_BeamCalF_Binning.tcl
    source CLIC/CLICdet_BeamCal_EnergyFractions.tcl
    source CLIC/CLICdet_BeamCal_Resolution_Stage3.tcl
}
...
###############################
# LumiCal energy flow merger
###############################
module Merger LumiMerger {
# add InputArray InputArray
  add InputArray LumiCalF/lumicalPhotons
  add InputArray LumiCalR/lumicalPhotons
  set OutputArray lumicalPhotons
}
...
##############################
# LumiCal photon efficiency
##############################
module Efficiency LumiEfficiency {
    set InputArray  LumiMerger/lumicalPhotons
    set OutputArray lumicalPhotons

    source CLIC/CLICdet_LumiCal_Efficiency_Stage3.tcl
}
...
module Efficiency BCalEfficiency {
    ...
    source CLIC/CLICdet_BeamCal_Efficiency_Stage3.tcl
}
...
module TreeWriter TreeWriter {
   ...
   ###with jet energy smearing
    ...
    add Branch LumiTowers/lumicalTowers LumiTower Tower

    add Branch LumiEfficiency/lumicalPhotons LumiPhoton Photon
