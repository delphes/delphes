...
module MomentumSmearing ChargedHadronMomentumSmearing {
	...
	(abs(eta) < 2.50 && abs(eta) >= 1.74 ) * 2 * sqrt( 8.56036e-05^2 * pt^2 +0.0148987^2    ) +
...
module MomentumSmearing ElectronMomentumSmearing {
    ...
    # CLICdet internal studies
    set ResolutionFormula {
	(abs(eta) < 2.50 && abs(eta) >= 1.74 ) * 2 * sqrt( 8.62283e-05^2 * pt^2  + 0.0177556^2   ) +
...
module MomentumSmearing MuonMomentumSmearing {
	...
	(abs(eta) < 2.50 && abs(eta) >= 1.74 ) 	 * 2 * sqrt(4.57439e-05^2 * pt^2   + 0.0149328^2	   ) +
