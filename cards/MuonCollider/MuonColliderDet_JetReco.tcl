...
############
#R02 N2
module FastJetFinder FastJetFinderVLC_R02_N2 {
    #  set InputArray Calorimeter/towers
    set InputArray EFlowFilter/eflow

    set OutputArray VLCjetsR02N2
...
#R02 N3
module FastJetFinder FastJetFinderVLC_R02_N3 {
    set InputArray EFlowFilter/eflow
    set OutputArray VLCjetsR02N3
    set NJets 3
    set ExclusiveClustering true
    set JetAlgorithm 9
    set ParameterR 0.2
...
#R02 N4
module FastJetFinder FastJetFinderVLC_R02_N4 {
    set InputArray EFlowFilter/eflow
    set OutputArray VLCjetsR02N4
    set NJets 4
    set ExclusiveClustering true
    set JetAlgorithm 9
    set ParameterR 0.2
...
#R02 N5
module FastJetFinder FastJetFinderVLC_R02_N5 {
    set InputArray EFlowFilter/eflow
    set OutputArray VLCjetsR02N5
    set NJets 5
    set ExclusiveClustering true
    set JetAlgorithm 9
    set ParameterR 0.2
...
#R02 N6
module FastJetFinder FastJetFinderVLC_R02_N6 {
    set InputArray EFlowFilter/eflow
    set OutputArray VLCjetsR02N6
    set NJets 6
    set ExclusiveClustering true
    set JetAlgorithm 9
    set ParameterR 0.2
...
########################
#R02
module FastJetFinder FastJetFinderVLC_R02_inclusive {
    set InputArray EFlowFilter/eflow
    set OutputArray VLCjetsR02_inclusive
