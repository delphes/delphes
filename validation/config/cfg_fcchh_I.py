...
eff_eftrack_plots = EfficiencyParticleBlock(eftracks, "EFlowTrack", mom, eta, eff_plots)

efphotons = [photon]
eff_efphoton_plots = EfficiencyParticleBlock(efphotons, "EFlowPhoton", mom, eta, eff_plots)

efnhs = [kl]
eff_efnh_plots = EfficiencyParticleBlock(efnhs, "EFlowNeutralHadron", mom, eta, eff_plots)
...
eff_btag_plots = EfficiencyTaggingBlock(
    "Jet", "btag", mom, eta, gen_cond_btag, [0, 1, 2], "BTag", eff_tag_plots
)

eff_ctag_plots = EfficiencyTaggingBlock(
    "Jet", "ctag", mom, eta, gen_cond_ctag, [4, 5, 6], "BTag", eff_tag_plots
)

eff_tautag_plots = EfficiencyTaggingBlock(
    "Jet", "tautag", mom, eta, gen_cond_tautag, [0, 1, 2], "TauTag", eff_tag_plots
)
...
Jets:
    ...
    Tagging Efficiency:
          ...
          btag: vs pt (3WPs) (eta central) 0, 2.5
          btag: vs pt (3WPs) (eta fwd)   2.5, 4.0
          btag: vs pt (3WPs) (eta fwd2)   4.0, 6.0

          btag: vs eta (3WPs) (eta central) 30 < pt < 60
          btag: vs eta (3WPs) (eta fwd)   60 < 200
          btag: vs pt (3WPs) (eta fwd2)   4.0, 6.0

          gen_bjets, reco_bjet_l, pt, eta_slice
          gen_bjets, reco_bjet_m, pt, eta_slice
          gen_bjets, reco_bjet_t, pt, eta_slice
